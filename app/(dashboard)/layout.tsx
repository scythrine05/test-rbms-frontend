      ...
      <body className={`${geistSans.variable} font-sans bg-gray-50 min-h-screen`}>
        <div className="flex flex-col min-h-screen">
          ...
          <nav className="bg-[#3277BC] text-white h-12 md:h-10 flex items-center px-4 shadow-sm z-30 sticky top-0">
            ...
            <span className="ml-2 md:ml-3 text-xs text-white/80 truncate">Employee Portal</span>
          ...
          <div className="flex flex-1 bg-white relative">
            ...
            <main className="flex-1 p-4 sm:p-5 md:p-6 overflow-auto w-full md:w-[calc(100%-12rem)]">{children}</main>
          </div>
          {/* Footer - Responsive */}
          <footer className="bg-white border-t border-gray-200 py-2 md:py-3 text-center text-xs text-gray-500 mt-auto">
            <p className="px-4">© {new Date().getFullYear()} Southern Railway. All rights reserved.</p>
          </footer>
        </div>
      </body>
    </html>
