...
//       adjacentLinesAffected: data.adjacentLinesAffected || "",
...
//   setFormData(prev => {
//     const currentArray = prev.powerBlockRequirements || [];
//     return {
//       ...prev,
//       [name]: checked
//         ? [...currentArray, value]
...
//   name="sanctionStatus"
//   value="false"
//   checked={formData.isSanctioned === true} // Must be strict boolean
//   onChange={() => {}} // Read-only
//   disabled
// />
...
//   name="sanctionStatus"
//   value="false"
//   checked={formData.isSanctioned === false} // Must be strict boolean
//   onChange={() => {}} // Read-only
//   disabled
// />
...
//     {/* Conditional fields when PB Required is YES */}
//     {formData.powerBlockRequired && (
//       <div className="mt-2 space-y-2">
//         {/* Gears Required Checkbox */}
